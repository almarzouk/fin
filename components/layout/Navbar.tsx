...
const navKeys: Record<string, "dashboard" | "salary" | "monthlyPlan" | "expenses" | "investments" | "savings" | "reports"> = {
  "/dashboard": "dashboard",
  "/salary": "salary",
...
export function Navbar() {
  ...
  const pageKey = Object.entries(navKeys).find(([href]) =>
    href === pathname || (href !== "/dashboard" && pathname.startsWith(href))
  )?.[1];
  const pageTitle = pageKey ? t.nav[pageKey] : t.app.title;
